...
#define KBaseURL @"http://mobads.baidu.com/cpro/ui/mads.php"
...
- (void)loadADData{
    ...
    //发送请求
    [manager GET:KBaseURL parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
